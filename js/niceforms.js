...
var imagesPath = "http://127.0.0.1/iup/images/";
...
function inputCheck(el) { //extend Checkboxes
	...
	el.dummy.ref = el;
	if(isIE == false) {el.dummy.style.left = findPosX(el) + 'px';el.dummy.style.top = (findPosY(el)) + 'px';}
	else {el.dummy.style.left = findPosX(el) + 6 + 'px';el.dummy.style.top = findPosY(el) + 24 + 'px';}
	el.dummy.onclick = function() {
            if(el.name == "professeur")
              {
                  if(!this.ref.checked)
...
function textarea(el) { //extend Textareas
	...
	el.width = el.offsetWidth - textareaSidePadding-10;
	...
	el.init = function() {
		...
		el.style.width = el.topRight.style.width = el.bottomRight.style.width = 220 + 'px';
...
function selects(el) { //extend Selects
	...
	el.dummy.style.width = (el.offsetWidth+30) + 'px';
	el.dummy.ref = el;
	el.left = document.createElement('img');
	el.left.src = imagesPath + "0.png";
	...
	el.dummy.style.left = (findPosX(el)-20) + 'px';
	el.dummy.style.top = (findPosY(el)+16) + 'px';
