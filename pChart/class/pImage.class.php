   ...
   function getTextBox_deprecated($X,$Y,$FontName,$FontSize,$Angle,$Text)
    {
     ...
     $Size    = imagettfbbox($FontSize,$Angle,substr(APPPATH,0,-12).$FontName,$Text); // Modif By Med Bakar
   ...
   function getTextBox($X,$Y,$FontName,$FontSize,$Angle,$Text)
    {
     ...
     $coords = imagettfbbox($FontSize, 0, substr(APPPATH,0,-12).$FontName, $Text); //Modif by MedBakar
